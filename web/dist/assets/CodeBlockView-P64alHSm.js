import{bj as h,c7 as V,ba as k,ci as a,b9 as e,bf as t,c1 as o,b_ as r,ap as b,an as i,be as d,aq as u,bc as w,bT as B,F as C,b3 as x,bR as f,bM as y,b2 as I}from"./index-pWzGLlVE.js";import{P as N}from"./PageHeader-v4cUJ2fI.js";import{C as l}from"./CodeBlock-mTkXuiBz.js";import"./IconCopy-D6cf29Wj.js";const E={class:"ds-page"},R={class:"ds-card__title"},D={class:"ds-props"},M={class:"ds-row"},O={class:"ds-controls"},T={class:"ds-row ds-row--border"},S={class:"ds-controls"},A={class:"ds-card__title"},L={class:"ds-card__title"},q={class:"variants"},F={class:"variant-item"},P={class:"variant-item"},U={class:"variant-item"},j={class:"variant-item"},H={class:"ds-card__title"},$={class:"lang-grid"},p=`def fetch_vacancies(status: str, limit: int = 50) -> list[Vacancy]:
