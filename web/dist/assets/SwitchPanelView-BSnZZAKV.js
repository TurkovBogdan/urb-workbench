import{bj as P,c6 as U,bQ as y,ba as k,ch as V,b9 as s,bf as l,c0 as i,b_ as n,be as O,bc as S,bT as T,F as x,b3 as D,bR as d,bM as r,b2 as C}from"./index-CbGvUGSv.js";import{P as E}from"./PageHeader-B7gvm_nR.js";import{S as a}from"./SwitchPanel-DPMmNCnP.js";import{C as B}from"./CodeBlock-DSqk4qPX.js";import"./IconCopy-BJqZrpb5.js";const j={class:"ds-page"},I={class:"ds-section"},N={class:"mb-3"},$={class:"ds-card"},F={class:"ds-row"},H={class:"ds-controls"},M={class:"ds-row"},z={class:"ds-controls"},L={class:"ds-row"},Q={class:"ds-controls"},R={class:"ds-section"},q={class:"mb-3"},A={class:"ds-card"},G={class:"ds-row"},J={class:"ds-controls"},K={class:"ds-section"},W={class:"mb-3"},X={class:"ds-card"},Y={class:"ds-tag"},Z={class:"ds-controls"},ss={class:"ds-spec"},es={class:"ds-section"},ts={class:"mb-3"},os={class:"ds-card"},is={class:"ds-tag"},ns={class:"ds-controls"},ls={class:"ds-spec"},as={class:"ds-section"},ds={class:"mb-3"},cs={class:"ds-card"},ps={class:"ds-row"},rs={class:"ds-controls"},ms={class:"ds-section"},us={class:"mb-3"},hs=`<script setup lang="ts">
import { ref } from 'vue'
