import{bg as V,c0 as h,b7 as k,cb as a,b6 as e,bc as t,bX as o,bV as r,an as b,al as i,bb as d,ao as u,b9 as w,bO as B,F as C,b0 as x,bM as f,bH as g,a$ as I}from"./index-CtJp1Su1.js";import{P as N}from"./PageHeader-CMmgx8Sl.js";import{C as l}from"./CodeBlock-CswMfkng.js";const E={class:"ds-page"},O={class:"ds-card__title"},D={class:"ds-props"},M={class:"ds-row"},R={class:"ds-controls"},S={class:"ds-row ds-row--border"},T={class:"ds-controls"},A={class:"ds-card__title"},L={class:"ds-card__title"},F={class:"variants"},H={class:"variant-item"},P={class:"variant-item"},U={class:"variant-item"},$={class:"variant-item"},q={class:"ds-card__title"},j={class:"lang-grid"},m=`def fetch_vacancies(status: str, limit: int = 50) -> list[Vacancy]:
